...
import { PanelLeft, Wallet, X } from "lucide-react"
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:ml-[--sidebar-width-icon]", // Default margin for collapsed on md
        "peer-data-[state=expanded]:md:ml-[--sidebar-width]", // Margin for expanded
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2 text-sidebar-foreground", className)}
      {...props}
    />
  )
})
